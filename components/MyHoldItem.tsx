//@ts-ignore
import { HoldItem as TheirHoldItem } from "react-native-hold-menu";
...
export const HoldItem: React.FC<HoldItemProps> = (props) => {
  return <TheirHoldItem menuAnchorPosition="top-center" {...props} />;
};
